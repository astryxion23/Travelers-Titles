...
public class ConfigDimensions {
    ...
    public final TTConfig.StrValue dimensionBlacklist;
    public final TTConfig.BoolValue centerText;
    public final TTConfig.BoolValue onlyUpdateAtSurface;

    public ConfigDimensions(final Configuration cfg) {
        final String c = "Dimension Titles";

        enabled = new TTConfig.BoolValue(cfg.get(c, "Enable Dimension Titles", true));
        ...
        textDisplayTime = new TTConfig.IntValue(cfg.get(c, "Text Display Time", 70,
            " How long the text displays, in ticks.\n" +
                " 20 ticks = 1 second.\n" +
                " Default: 70",
            0, Integer.MAX_VALUE));

        textFadeOutTime = new TTConfig.IntValue(cfg.get(c, "Text Fade-Out Time", 20,
        ...
        textSize = new TTConfig.DoubleValue(cfg.get(c, "Text Size", 3.0,
            " The text's scale.\n" +
                " Default: 3.0",
            0.01d, 1000d));
        ...
        textYOffset = new TTConfig.DoubleValue(cfg.get(c, "Text Y Offset", -32.0,
        ...
        onlyUpdateAtSurface = new TTConfig.BoolValue(cfg.get(c, "Only Show Dimension Titles When Exposed To Skylight", false,
