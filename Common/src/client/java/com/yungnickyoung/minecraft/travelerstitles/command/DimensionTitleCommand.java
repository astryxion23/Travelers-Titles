...
public class DimensionTitleCommand {
    ...
    public static int displayTitle(CommandSourceStack commandSource, ServerLevel world) {
        ...
        String dimensionColorStr = Language.getInstance().has(dimensionColorKey)
            ...
            : TravelersTitlesClient.TITLE_MANAGER.dimensionTitleRenderer.titleDefaultTextColor;

        // Set display
        TravelersTitlesClient.TITLE_MANAGER.dimensionTitleRenderer.setColor(dimensionColorStr);
        TravelersTitlesClient.TITLE_MANAGER.dimensionTitleRenderer.displayTitle(dimensionTitle, null);
